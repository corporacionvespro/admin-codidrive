            ...
            <div class="card">
                <form enctype="multipart/form-data" id="" method="post">
                    <div class="card-body px-lg-4 py-lg-4">
                        <h6 class="heading-small text-center mb-4">Registrar Ingresos</h6>
                            ...
                            <div class="col-md-12" id="bille_div" style="display:none">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="s_bille">
                                        ...
                                        <option value="IzipayYa">IzipayYa</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="t_comprobante">Comprobante de pago</label>
                                    <select class="form-control" id="t_comprobante">
                                        <option value="0"></option>
                                        <option value="Boleta de Venta">Boleta de Venta</option>
                                        <option value="Facturas">Facturas</option>
                                        <option value="Tickets">Tickets</option>
                                        <option value="Recibos por honorarios">Recibos por honorarios</option>
                                        <option value="Liquidaciones de compra">Liquidaciones de compra</option>
                                        <option value="Comprobante de Operaciones - Ley N° 29972">Comprobante de Operaciones - Ley N° 29972</option>
                                        <option value="Documentos autorizados">Documentos autorizados</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="example2cols1Input">N° de comprobante</label>
                                    <input type="text" id="comprobante" name="comprobante" class="form-control" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="example2cols1Input">Costo</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="example2cols1Input">Aporte</label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="guardarmonto" type="button" class="btn ml-auto" style="display:none;color:#fff;background: #50009f;border: #50009f;" onclick="regsaldo();">Registrar</button>
                    </div>
                </form>
            </div>
        </div>
...
<!-- Header -->
<div class="header bg-primary pb-6" style="background: linear-gradient(87deg, #5F00BE 0, #5F00BE 100%) !important;">
        ...
        <div class="header-body">
            <div class="row align-items-center py-4" style="margin-left: 5px;margin-right: 5px;">
                <div class="col-lg-12 col-12" style="text-align: center;background: none;height: 59px;display: flex;flex-direction: row;flex-wrap: nowrap;align-content: center;justify-content: center;align-items: center;border-radius: 50px;">
                    <h6 class="h2 d-inline-block mb-0 text-uppercase " style="color: #ffffff;">INGRESOS</h6>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid mt--6">
            ...
            <div class="card">
                <div class="card-header bg-transparent">
                    ...
                    <div class="col-md-12" style="display: flex;justify-content: space-between;">
                        ...
                        <form method="POST" action="create_excel_otrosingresos.php">
    ...
    <script>
        $(document).ready(function() {
            $(function() {
                $("#example").DataTable({
                    ...
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": "server_process_otrosingresos.php",
                });
        ...
        function datos() {
            document.getElementById("Deposito").options.item(0).selected = 'selected';
            document.getElementById("s_bille").options.item(0).selected = 'selected';
            document.getElementById("t_comprobante").options.item(0).selected = 'selected';
            $('#concepto').val('');
            $("#detalleact").val('');
            $("#comprobante").val('');
            $("#doc").val('');
            ...
            $('#deuda').val('');
            $('#f_reg').val('');
            var checkbox = document.getElementById("banc_efec");
            checkbox.checked = false;
            var selectElement = $('#states').select2();
        ...
        function regsaldo() {
            ...
            t_comprobante = $("#t_comprobante").val();

            $.ajax({
                type: "POST",
                url: "https://chapatutaxi.com/admin/agregar_ingresos.php",
                data: {
                    concepto: concepto,
                ...
                success: function(result2) {
                    ...
                    table2.fnReloadAjax('server_process_otrosingresos.php');
                    table2.fnReloadAjax(); /**/
