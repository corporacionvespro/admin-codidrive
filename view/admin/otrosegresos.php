            ...
            <div class="card">
                <form enctype="multipart/form-data" id="" method="post">
                    <div class="card-body px-lg-4 py-lg-4">
                        <h6 class="heading-small text-center mb-4">Registrar Egresos</h6>
        ...
        <div class="header-body">
            <div class="row align-items-center py-4" style="margin-left: 5px;margin-right: 5px;">
                <div class="col-lg-12 col-12" style="text-align: center;background: none;height: 59px;display: flex;flex-direction: row;flex-wrap: nowrap;align-content: center;justify-content: center;align-items: center;border-radius: 50px;">
                    <h6 class="h2 d-inline-block mb-0 text-uppercase " style="color: #ffffff;">EGRESOS</h6>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid mt--6">
            ...
            <div class="card">
                <div class="card-header bg-transparent">
                    ...
                    <div class="col-md-12" style="display: flex;justify-content: space-between;">
                        ...
                        <form method="POST" action="create_excel_otrosegresos.php">
    ...
    <script>
        $(document).ready(function() {
            $(function() {
                $("#example").DataTable({
                    ...
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": "server_process_otrosegresos.php",
                });
        ...
        function regsaldo() {
            ...
            $.ajax({
                type: "POST",
                url: "https://chapatutaxi.com/admin/agregar_egresos.php",
                data: {
                    concepto: concepto,
                ...
                success: function(result2) {
                    ...
                    table2.fnReloadAjax('server_process_otrosegresos.php');
                    table2.fnReloadAjax(); 
