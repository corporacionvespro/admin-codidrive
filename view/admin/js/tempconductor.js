...
document
  ...
  .addEventListener("keyup", validarPorcentaje);
...
function personalesdatos(idpersona, idcuenta) {
  ...
  $("#imagePreview2").css(
    "background-image",
    "url(https://codidrive.com/admin/assets/img/brand/logo.png)"
  );
  $("#imagePreview2").hide();
  $("#imagePreview2").fadeIn(650);
  /**/
  ...
  $.ajax(settings).done(function (response) {
    ...
    /**/
    if (
      json2.conductor.foto == "https://codidrive.com/codiapi/images/logo.png"
    ) {
