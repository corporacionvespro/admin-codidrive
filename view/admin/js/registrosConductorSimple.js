                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if (JSON.parse(res).estado === 'ok') {
                            ...
                            $('#txtvali').text('¡Estamos procesando tu solicitud! El equipo de Operaciones de Codi Drive se pondrá en contacto contigo en un plazo máximo de 3 días hábiles. ¡Gracias por tu comprensión y paciencia!');
