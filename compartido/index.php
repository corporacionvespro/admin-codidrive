...
<head>
    ...
    <link type="text/css" rel="stylesheet"
        href="https://fonts.googleapis.com/css?family=Google+Sans+Text:400&amp;text=%E2%86%90%E2%86%92%E2%86%91%E2%86%93&amp;lang=es">
    <style>
    .gm-ui-hover-effect {
        opacity: .6
    }
    ...
    *:focus {
    ...
    <script type="text/javascript" charset="UTF-8"
        src="https://maps.googleapis.com/maps-api-v3/api/js/57/4/intl/es_419/common.js"></script>
    <script type="text/javascript" charset="UTF-8"
        src="https://maps.googleapis.com/maps-api-v3/api/js/57/4/intl/es_419/util.js"></script>
    <script type="text/javascript" charset="UTF-8"
        src="https://maps.googleapis.com/maps-api-v3/api/js/57/4/intl/es_419/map.js"></script>
    <script type="text/javascript" charset="UTF-8"
        src="https://maps.googleapis.com/maps-api-v3/api/js/57/4/intl/es_419/marker.js"></script>
    <script type="text/javascript" charset="UTF-8"
        src="https://maps.googleapis.com/maps-api-v3/api/js/57/4/intl/es_419/onion.js"></script>
    <script type="text/javascript" charset="UTF-8"
        src="https://maps.googleapis.com/maps-api-v3/api/js/57/4/intl/es_419/controls.js"></script>
    <script type="text/javascript" charset="UTF-8"
        src="https://maps.googleapis.com/maps-api-v3/api/js/57/4/intl/es_419/common.js"></script>
    <script type="text/javascript" charset="UTF-8"
        src="https://maps.googleapis.com/maps-api-v3/api/js/57/4/intl/es_419/util.js"></script>
...
">
        ...
        <div class="d-flex" style="">
            <div class="" style="padding: 15px 10px 15px 0;">
                <img src="https://codidrive.com/admin/imagenes/playstore.png" class="img-fluid" alt="..."
                    style="width: 100px;">
            </div>
            <div class="" style="padding: 15px 0 15px 0;">
                <img src="https://codidrive.com/admin/imagenes/apple.png" class="img-fluid" alt="..."
                    style="width: 100px;">
            </div>
        </div>
    </div>
    <div class="container" style="display: flex;">
        <div class="" style="padding: 12px;">
            <img src="https://codidrive.com/admin/assets/img/brand/logo.png" class="img-fluid" alt="..."
                style="width: 49px;">
        </div>
        <div class=""
            style="display: flex;justify-content: center;flex-direction: column;flex-wrap: nowrap;align-items: flex-start;">
            <p style="
    padding: 0px;
    margin: 0px;
">Paulo César 4,87</p>
...
">plata alto M3L576</p>
    ...
    <div class="container" style="display: flex;padding: 0px 23px 18px 23px;">
        <div class=""
            style="display: flex;justify-content: flex-start;flex-direction: column;flex-wrap: nowrap;align-items: flex-start;">
            <p style="
    padding: 0px;
    margin: 0px;
"> <i class="fa-solid fa-location-dot"></i> Urb Santa Rosa</p>
...
">Hospital Regional de Lambayeque (Chiclayo)</p>
    ...
    <div id="div2" style="position: relative; overflow: hidden;">
        <div
            ...
            <div><button draggable="false" aria-label="Combinaciones de teclas" title="Combinaciones de teclas"
                    type="button"
            ...
            <div tabindex="0" aria-label="Mapa" aria-roledescription="mapa" role="region"
                aria-describedby="43DC9933-64BF-42FC-9274-7316AB7E6D43"
                style="position: absolute; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px; left: 0px; top: 0px;">
                <div id="43DC9933-64BF-42FC-9274-7316AB7E6D43" style="display: none;">
                    <div class="LGLeeN-keyboard-shortcuts-view">
                        <table>
                            <tbody>
                                <tr>
                                    <td><kbd aria-label="Flecha izquierda">←</kbd></td>
                                    <td aria-label="Mover a la izquierda.">Mover a la izquierda</td>
                                </tr>
                                <tr>
                                    <td><kbd aria-label="Flecha derecha">→</kbd></td>
                                    <td aria-label="Mover a la derecha.">Mover a la derecha</td>
                                </tr>
                                <tr>
                                    <td><kbd aria-label="Flecha hacia arriba">↑</kbd></td>
                                    <td aria-label="Mover hacia arriba.">Mover hacia arriba</td>
                                </tr>
                                <tr>
                                    <td><kbd aria-label="Flecha hacia abajo">↓</kbd></td>
                                    <td aria-label="Mover hacia abajo.">Mover hacia abajo</td>
                                </tr>
                                <tr>
                                    <td><kbd>+</kbd></td>
                                    <td aria-label="Acercar.">Acercar</td>
                                </tr>
                                <tr>
                                    <td><kbd>-</kbd></td>
                                    <td aria-label="Alejar.">Alejar</td>
                                </tr>
                                <tr>
                                    <td><kbd>Inicio</kbd></td>
                                    <td aria-label="Mover a la izquierda un 75%.">Mover a la izquierda un 75%</td>
                                </tr>
                                <tr>
                                    <td><kbd>Fin</kbd></td>
                                    <td aria-label="Mover a la derecha un 75%.">Mover a la derecha un 75%</td>
                                </tr>
                                <tr>
                                    <td><kbd>Página anterior</kbd></td>
                                    <td aria-label="Mover hacia arriba un 75%.">Mover hacia arriba un 75%</td>
                                </tr>
                                <tr>
                                    <td><kbd>Página siguiente</kbd></td>
                                    <td aria-label="Mover hacia abajo un 75%.">Mover hacia abajo un 75%</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="gm-style"
                    ...
                    <div
                        ...
                        <div style="position: absolute; left: 0px; top: 0px; z-index: 100; width: 100%;">
                            <div style="position: absolute; left: 0px; top: 0px; z-index: 0;">
                                <div
                                    style="position: absolute; z-index: 984; transform: matrix(1, 0, 0, 1, -172, -201);">
                                    <div
                        ...
                        <div style="position: absolute; left: 0px; top: 0px; z-index: 103; width: 100%;">
                            <div
                                ...
                                <img alt="" src="https://maps.gstatic.com/mapfiles/api-3/images/spotlight-poi3.png"
                                    draggable="false"
                        ...
                        <div style="position: absolute; left: 0px; top: 0px; z-index: 0;">
                            <div style="position: absolute; z-index: 984; transform: matrix(1, 0, 0, 1, -172, -201);">
                                <div
                                ...
                                <div
                                    ...
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18232!3i34002!4i256!2m3!1e0!2sm!3i696442329!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=110304"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: -256px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18232!3i34001!4i256!2m3!1e0!2sm!3i696442329!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=46983"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: 0px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18233!3i34001!4i256!2m3!1e0!2sm!3i696442425!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=63348"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: 256px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18234!3i34001!4i256!2m3!1e0!2sm!3i696442425!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=33105"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: 256px; top: 256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18234!3i34002!4i256!2m3!1e0!2sm!3i696442425!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=96426"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: -256px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18232!3i34000!4i256!2m3!1e0!2sm!3i696442329!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=114733"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: 0px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18233!3i34000!4i256!2m3!1e0!2sm!3i696442473!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=112509"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: 256px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18234!3i34000!4i256!2m3!1e0!2sm!3i696442473!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=82266"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: -512px; top: 256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18231!3i34002!4i256!2m3!1e0!2sm!3i696442329!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=9476"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: -512px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18231!3i34001!4i256!2m3!1e0!2sm!3i696442329!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=77226"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: -768px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18230!3i34000!4i256!2m3!1e0!2sm!3i696442413!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=62496"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: -768px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18230!3i34001!4i256!2m3!1e0!2sm!3i696442365!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=60620"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: -768px; top: 256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18230!3i34002!4i256!2m3!1e0!2sm!3i696442269!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=77333"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: 768px; top: 256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18236!3i34002!4i256!2m3!1e0!2sm!3i696442209!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=17275"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: 768px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18236!3i34001!4i256!2m3!1e0!2sm!3i696442245!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=38176"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: 768px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18236!3i34000!4i256!2m3!1e0!2sm!3i696442245!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=105926"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: -512px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18231!3i34000!4i256!2m3!1e0!2sm!3i696442413!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=32253"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: 512px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18235!3i34001!4i256!2m3!1e0!2sm!3i696442425!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=2862"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: 512px; top: 256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18235!3i34002!4i256!2m3!1e0!2sm!3i696442425!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=66183"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                                <div
                                    style="position: absolute; left: 512px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                                    <img draggable="false" alt="" role="presentation"
                                        src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i16!2i18235!3i34000!4i256!2m3!1e0!2sm!3i696442473!2m3!1e2!6m1!3e5!3m17!2ses-419!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!2zcC5zOi02MHxwLmw6LTYw!4e0!5m1!1e3&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI&amp;token=52023"
                                        style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div style="position: absolute; left: 0px; top: 0px; z-index: 106; width: 100%;"><span
                                    id="9EF52C02-AFCE-4C8B-A244-65B7A83E52D3" style="display: none;">Para navegar,
                                    presiona las teclas de flecha.</span>
                                <div aria-label="Latitude:-6.761634055390451 | Longitude:-79.83944636137045" role="img"
                                    tabindex="-1"
                                    style="width: 26px; height: 37px; overflow: hidden; position: absolute; left: -13px; top: -37px; z-index: 0;">
                                    <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png"
                                        ...
                                        name="gmimap0" id="gmimap0"><area log="miw"
                                            coords="13,0,4,3.5,0,12,2.75,21,13,37,23.5,21,26,12,22,3.5" shape="poly"
                                            tabindex="-1"
                                            title="Latitude:-6.761634055390451 | Longitude:-79.83944636137045"
                ...
                <div></div>
                <div></div>
                <div><button draggable="false" aria-label="Activar o desactivar la vista de pantalla completa"
                        title="Activar o desactivar la vista de pantalla completa" type="button" aria-pressed="false"
                ...
                <div>
                    <div class="gmnoprint gm-bundled-control gm-bundled-control-on-bottom" draggable="false"
                        data-control-width="40" data-control-height="113"
                        ...
                        <div class="gmnoprint" data-control-width="40" data-control-height="40"
                            ...
                            <div
                                ...
                                <button draggable="false" aria-label="Girar el mapa a la derecha"
                                    title="Girar el mapa a la derecha" type="button" class="gm-control-active"
                                ...
                                </div><button draggable="false" aria-label="Girar el mapa a la izquierda"
                                    title="Girar el mapa a la izquierda" type="button" class="gm-control-active"
                                ...
                                <div
                                    style="position: relative; overflow: hidden; width: 30px; height: 1px; margin: 0px 5px; background-color: rgb(230, 230, 230); display: none;">
                                </div><button draggable="false" aria-label="Inclinar el mapa" title="Inclinar el mapa"
                            ...
                            aria-label="Arrastra el hombrecito naranja al mapa para abrir Street&nbsp;View"
                            title="Arrastra el hombrecito naranja al mapa para abrir Street&nbsp;View" type="button"
                        ...
                        <div class="gmnoprint" data-control-width="40" data-control-height="81"
                            ...
                            <div draggable="false"
                                ...
                                <button draggable="false" aria-label="Acercar" title="Acercar" type="button"
                                ...
                                </div><button draggable="false" aria-label="Alejar" title="Alejar" type="button"
                                    class="gm-control-active"
                                    style="background: none; display: block; border: 0px; margin: 0px; padding: 0px; text-transform: none; appearance: none; position: relative; cursor: pointer; user-select: none; overflow: hidden; width: 40px; height: 40px; top: 0px; left: 0px;"><img
                ...
                <div>
                    <div style="margin: 0px 5px; z-index: 1000000; position: absolute; left: 0px; bottom: 0px;"><a
                            ...
                            href="https://maps.google.com/maps?ll=-6.761634,-79.839446&amp;z=16&amp;t=m&amp;hl=es-419&amp;gl=US&amp;mapclient=apiv3"
                    ...
                    <div style="display: inline-flex; position: absolute; right: 0px; bottom: 0px;">
                        ...
                        <div class="gmnoscreen">
                            <div
                                ...
                                Datos del mapa ©2024</div>
                        </div><button draggable="false" aria-label="Escala del mapa: 100 m por 42 píxeles"
                            title="Escala del mapa: 100 m por 42 píxeles" type="button" class="gm-style-cc"
                            aria-describedby="9BD8A035-A17C-4E11-8894-BE682E360F85"
                            ...
                            </div><span id="9BD8A035-A17C-4E11-8894-BE682E360F85" style="display: none;">Hacer clic para
                                alternar entre unidades imperiales y métricas</span>
                        </button>
                        <div class="gmnoprint gm-style-cc" draggable="false"
                            ...
                            <div
                                ...
                                <a href="https://www.google.com/intl/es-419_US/help/terms_maps.html" target="_blank"
                                    rel="noopener"
                                    style="text-decoration: none; cursor: pointer; color: rgb(0, 0, 0);">Condiciones</a>
                            </div>
                        </div>
                        <div draggable="false" class="gm-style-cc"
                            style="user-select: none; position: relative; height: 14px; line-height: 14px;">
        ...
        <div
            ...
            <div style="line-height: 20px; margin: 15px 0px;"><span
                    style="color: rgba(0, 0, 0, 0.87); font-size: 14px;">Esta página no puede cargar Google&nbsp;Maps
                    correctamente.</span></div>
            <table style="width: 100%;">
                <tr>
                    <td style="line-height: 16px; vertical-align: middle;"><a href="http://g.co/dev/maps-no-account"
                            target="_blank" rel="noopener" style="color: rgba(0, 0, 0, 0.54); font-size: 12px;">¿Eres el
                            propietario de este sitio web?</a></td>
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?v=3.exp&amp;libraries=places&amp;key=AIzaSyB7FIwlIrSNJA9dz77tHakwVLhOhzsXkTI">
    </script>
    <script>
    /**/
