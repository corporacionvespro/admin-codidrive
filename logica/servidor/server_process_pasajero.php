...
while ($aRow = $rResult->fetch_array()) {
	...
	for ($i = 0; $i < count($aColumnas2); $i++) {
		if ($aColumnas2[$i] == "persona" || $aColumnas2[$i] == "pasajero") {
			...
			//$row[] = "<td><img src='https://chapatutaxi.com/codiapi/images/".$aRow[$aColumnas2[$i]]."' class='circle' style='width: 70px;height: 70px;overflow: hidden;border-radius: 45px;border: none;text-align: center;object-fit: cover;color: transparent;text-indent: 10000px;'></td>";
	...
	$row[] = "<td class='text-center'><span style='font-size: 19px;font-weight: bold;color: #01296e;background: #ecf7fd;padding: 2px 10px 2px 10px;border-radius: 25px;'>{$aRow['solicitudes']}</span></td>";
