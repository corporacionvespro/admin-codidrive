...
while ($aRow = $rResult->fetch_array()) {
	...
	for ($i = 0; $i < count($aColumnas2); $i++) {
		if ($aColumnas2[$i] == "persona" || $aColumnas2[$i] == "pasajero") {
			...
			//$row[] = "<td><img src='https://codidrive.com/codiapi/images/".$aRow[$aColumnas2[$i]]."' class='circle' style='width: 70px;height: 70px;overflow: hidden;border-radius: 45px;border: none;text-align: center;object-fit: cover;color: transparent;text-indent: 10000px;'></td>";
