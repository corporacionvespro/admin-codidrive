...
VALUES (:detalle, :monto, :fechahora, :f_reg, :monto, :deuda, :importe, :precio, :concepto, 0, :nombrecl, :doc, 1, :userId, :nombre_usuario, :estado_deuda)";
    ...
    if ($stmt2->execute()) {
        $query_s = $pdo->query("SELECT id FROM `otrosegresos` ORDER BY `id` DESC LIMIT 1");
        ...
        VALUES (:importe, 'Egreso pago de deuda', :tipo_opreacion, :metodo_pago, :tipo_caja, :tipo_pago, 1, :detalleact, :complemento, :userId, :fecha, :hora24, 'egreso')";
