...
function TildesHtml($cadena)
{
    return str_replace(
        ...
        array("&rsquo;", "&aacute;", "&eacute;", "&iacute;", "&oacute;", "&uacute;", "&ntilde;", "&Aacute;", "&Eacute;", "&Iacute;", "&Oacute;", "&Uacute;", "&Ntilde;"),
        $cadena
    );
}
...
$query2 = "INSERT INTO `otrosingresos`(`detalle`, `monto`, `fecha_hora`, `fecha_reg`, `monto_anterior`, `deuda`, `aporte`,`precio`, `concepto`, `id_cliente`, `nombre_cliente`, `documento_cliente`, `estado`, `usuario`, `nombre`, `estado_deuda`,`comprobante`,`t_comprobante`) 
...
if ($stmt->execute()) {
    ...
    $query4 = "INSERT INTO `operaciones` (`monto`,`concepto`, `tipo_opreacion`, `metodo_pago`, `tipo_caja`,`tipo_pago`, `estado`, `detalle`, `complemento`, `usuario`, `fecha`, `hora`) VALUES (:importe, 'Otro ingreso', :tipo_opreacion, :metodo_pago, :tipo_caja, :tipo_pago, 1, :detalleact, :complemento, :userId, :fecha, :hora24)";
