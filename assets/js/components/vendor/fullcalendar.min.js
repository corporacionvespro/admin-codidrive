...
var Fullcalendar = function() {
    ...
    i.length && (t = {
        ...
        "update" === t && ("" != a ? (s[0].title = a, s[0].description = n, s[0].className = [l], e.fullCalendar("updateEvent", s[0]), $("#edit-event").modal("hide")) : ($(".edit-event--title").closest(".form-group").addClass("has-error"), $(".edit-event--title").focus())), "delete" === t && ($("#edit-event").modal("hide"), setTimeout(function() {
            swal({
                title: "Are you sure?",
